  ...
  return (
    ...
    >
      ...
      <div className="max-w-[1440px] mx-auto relative z-100 px-4 sm:px-6 lg:px-0">
        <motion.div
          ref={containerRef}
          className="border-[0.5px] border-white h-[250px] sm:h-[400px] lg:h-[511px] py-8 sm:py-12 lg:py-[63px] px-6 sm:px-8 lg:px-[34px] rounded-[19px] flex flex-col items-start relative"
